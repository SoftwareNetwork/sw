...
/**
 ** \file G:/dev/cppan_client/src/bazel/grammar.hpp
 ** Define the yy_bazel::parser class.
 */

// C++ LALR(1) parser skeleton written by Akim Demaille.

#ifndef YY_YY_BAZEL_G_DEV_CPPAN_CLIENT_SRC_BAZEL_GRAMMAR_HPP_INCLUDED
# define YY_YY_BAZEL_G_DEV_CPPAN_CLIENT_SRC_BAZEL_GRAMMAR_HPP_INCLUDED
// //                    "%code requires" blocks.
#line 33 "G:/dev/cppan_client/src/bazel/grammar.yy" // lalr1.cc:377

#include "bazel/bazel.h"

class BazelParserDriver;

#line 50 "G:/dev/cppan_client/src/bazel/grammar.hpp" // lalr1.cc:377
...
/* Debug traces.  */
#ifndef YY_BAZELDEBUG
# if defined YYDEBUG
#if YYDEBUG
#   define YY_BAZELDEBUG 1
#  else
#   define YY_BAZELDEBUG 0
#  endif
# else /* ! defined YYDEBUG */
#  define YY_BAZELDEBUG 1
# endif /* ! defined YYDEBUG */
#endif  /* ! defined YY_BAZELDEBUG */


namespace yy_bazel {
#line 135 "G:/dev/cppan_client/src/bazel/grammar.hpp" // lalr1.cc:377
  ...
  {
  public:
#ifndef YY_BAZELSTYPE
    /// An auxiliary type to compute the largest semantic type.
    union union_type
    {
      // statements
      char dummy1[sizeof(bazel::File)];

      // statement
      // function_call
      char dummy2[sizeof(bazel::Function)];

      // parameter
      // variable_decl
      char dummy3[sizeof(bazel::Parameter)];
      ...
      // array_contents
      // array_content
      char dummy5[sizeof(bazel::Values)];
...
#else
    typedef YY_BAZELSTYPE semantic_type;
#endif
    /// Symbol locations.
  ...
  basic_symbol (typename Base::kind_type t, const bazel::File v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const bazel::Function v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const bazel::Parameter v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const bazel::Parameters v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const bazel::Values v, const location_type& l);
  ...
  basic_symbol (typename Base::kind_type t, const std::string v, const location_type& l);
    ...
    static inline
    symbol_type
    make_EOQ (const location_type& l);

    static inline
    symbol_type
    make_ERROR_SYMBOL (const location_type& l);
    ...
    static inline
    symbol_type
    make_R_ARROW (const location_type& l);
    ...
    parser (BazelParserDriver &driver_yyarg);
    virtual ~parser ();
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const bazel::File v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const bazel::Function v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const bazel::Parameter v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const bazel::Parameters v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const bazel::Values v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  parser::symbol_type
  parser::make_EOQ (const location_type& l)
  {
    return symbol_type (token::EOQ, l);
  }

  parser::symbol_type
  parser::make_ERROR_SYMBOL (const location_type& l)
  {
    return symbol_type (token::ERROR_SYMBOL, l);
  }
  ...
  parser::symbol_type
  parser::make_L_CURLY_BRACKET (const location_type& l)
  {
    return symbol_type (token::L_CURLY_BRACKET, l);
  }

  parser::symbol_type
  parser::make_R_CURLY_BRACKET (const location_type& l)
  {
  ...
  parser::symbol_type
  parser::make_R_ARROW (const location_type& l)
  {
    return symbol_type (token::R_ARROW, l);
  }
...
#line 1350 "G:/dev/cppan_client/src/bazel/grammar.hpp" // lalr1.cc:377




#endif // !YY_YY_BAZEL_G_DEV_CPPAN_CLIENT_SRC_BAZEL_GRAMMAR_HPP_INCLUDED
