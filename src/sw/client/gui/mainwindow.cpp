...
void MainWindow::setupUi()
{
    ...
    // create
    {
        ...
        cl_option_add_widget("Overwrite existing files (THIS WILL OVERWRITE YOUR CHANGES)",
            l, swctx.getOptions().options_create.create_overwrite_files, swctx.getClOptions().create_overwrite_files, true);
...
#undef SUBCOMMAND
    ...
    // settings
    {
        ...
        connect(t, &TabWidget::currentChanged, [idx, this, sa](int i)
        {
            ...
            createOptionWidgets(setLayout, swctx.getOptions(), swctx.getClOptions());
